  ...
  return (
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
          ...
          <h1 className="absolute inset-x-0 top-1/200 text-center text-yellow-400 font-extrabold uppercase text-[6rem] md:text-[8rem] lg:text-[10rem] opacity-20 select-none pointer-events-none">
            CoinKeeper
          </h1>
          ...
          >
            ...
            >
              {status === 'loading' ? 'Загрузка...' : 'Создать аккаунт'}
            </button>
